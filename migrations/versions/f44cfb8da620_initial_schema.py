...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['vendor_id'], ['vendors.id'], name=op.f('fk_accounts_vendor_id_vendors')),
    sa.PrimaryKeyConstraint('id', name=op.f('pk_accounts'))
    )
    with op.batch_alter_table('accounts', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_accounts_owner_id'), ['owner_id'], unique=False)
        batch_op.create_index(batch_op.f('ix_accounts_vendor_id'), ['vendor_id'], unique=False)

    op.create_table('analysis_periods',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('name', sa.String(length=120), nullable=False),
    ...
    sa.Column('created_at', sa.DateTime(), server_default=sa.text('(CURRENT_TIMESTAMP)'), nullable=False),
    sa.Column('updated_at', sa.DateTime(), server_default=sa.text('(CURRENT_TIMESTAMP)'), nullable=False),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], name=op.f('fk_analysis_periods_user_id_users')),
    ...
    with op.batch_alter_table('analysis_periods', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_analysis_periods_user_id'), ['user_id'], unique=False)

    op.create_table('budgeted_expenses',
    sa.Column('id', sa.Integer(), nullable=False),
    ...
    sa.Column('created_at', sa.DateTime(), server_default=sa.text('(CURRENT_TIMESTAMP)'), nullable=False),
    sa.Column('updated_at', sa.DateTime(), server_default=sa.text('(CURRENT_TIMESTAMP)'), nullable=False),
    sa.ForeignKeyConstraint(['category_id'], ['categories.id'], name=op.f('fk_budgeted_expenses_category_id_categories')),
    sa.ForeignKeyConstraint(['subcategory_id'], ['categories.id'], name=op.f('fk_budgeted_expenses_subcategory_id_categories')),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], name=op.f('fk_budgeted_expenses_user_id_users')),
    ...
    with op.batch_alter_table('budgeted_expenses', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_budgeted_expenses_category_id'), ['category_id'], unique=False)
        batch_op.create_index(batch_op.f('ix_budgeted_expenses_date_scheduled'), ['date_scheduled'], unique=False)
        batch_op.create_index(batch_op.f('ix_budgeted_expenses_payee'), ['payee'], unique=False)
        batch_op.create_index(batch_op.f('ix_budgeted_expenses_subcategory_id'), ['subcategory_id'], unique=False)
        batch_op.create_index(batch_op.f('ix_budgeted_expenses_user_id'), ['user_id'], unique=False)
    ...
    sa.Column('created_at', sa.DateTime(), server_default=sa.text('(CURRENT_TIMESTAMP)'), nullable=False),
    sa.Column('updated_at', sa.DateTime(), server_default=sa.text('(CURRENT_TIMESTAMP)'), nullable=False),
    sa.ForeignKeyConstraint(['category_id'], ['categories.id'], name=op.f('fk_expense_analysis_category_id_categories')),
    sa.ForeignKeyConstraint(['period_id'], ['analysis_periods.id'], name=op.f('fk_expense_analysis_period_id_analysis_periods')),
    sa.ForeignKeyConstraint(['subcategory_id'], ['categories.id'], name=op.f('fk_expense_analysis_subcategory_id_categories')),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], name=op.f('fk_expense_analysis_user_id_users')),
    sa.PrimaryKeyConstraint('id', name=op.f('pk_expense_analysis')),
    sa.UniqueConstraint('period_id', 'user_id', 'category_id', 'subcategory_id', name='uq_expense_analysis_period_user_category_subcategory')
    )
    with op.batch_alter_table('expense_analysis', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_expense_analysis_category_id'), ['category_id'], unique=False)
        batch_op.create_index(batch_op.f('ix_expense_analysis_period_id'), ['period_id'], unique=False)
        batch_op.create_index(batch_op.f('ix_expense_analysis_subcategory_id'), ['subcategory_id'], unique=False)
        batch_op.create_index(batch_op.f('ix_expense_analysis_user_id'), ['user_id'], unique=False)
    ...
    sa.ForeignKeyConstraint(['credit_account_id'], ['accounts.id'], name=op.f('fk_transactions_credit_account_id_accounts')),
    sa.ForeignKeyConstraint(['debit_account_id'], ['accounts.id'], name=op.f('fk_transactions_debit_account_id_accounts')),
    sa.ForeignKeyConstraint(['subcategory_id'], ['categories.id'], name=op.f('fk_transactions_subcategory_id_categories')),
    ...
    with op.batch_alter_table('transactions', schema=None) as batch_op:
        ...
        batch_op.create_index(batch_op.f('ix_transactions_credit_account_id'), ['credit_account_id'], unique=False)
        batch_op.create_index(batch_op.f('ix_transactions_debit_account_id'), ['debit_account_id'], unique=False)
        batch_op.create_index(batch_op.f('ix_transactions_payee'), ['payee'], unique=False)
        ...
        batch_op.create_index('ix_transactions_user_id_transaction_date', ['user_id', 'transaction_date'], unique=False)
